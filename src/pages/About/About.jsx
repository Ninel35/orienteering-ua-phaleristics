     ...
     <article className={css.article}>
       ...
       <figure className={css.left}>
         ...
         <div>
           ...
           для України – і одразу золоту! – виборов 1995 року в Німеччині Юрій
           Омельченко.
         </div>
       </figure>
       <figure className={css.right}>
         <div>
           ...
           Ірина Купріянова, Вікторія Плохенко та Наталія Потопальська (в
           естафеті).
         </div>
       ...
       <figure className={css.left}>
         ...
         <div>
           ...
           здобули для України 2013 року у Фінляндії Павло Ушкварок, Олександр
           Кратов та Денис Щербаков.
         </div>
       </figure>
       <figure className={css.right}>
         <div>
           Першу серед орієнтувальників медаль Всесвітніх ігор неолімпійських
           видів спорту (World Games IWGA) здобула у 2013 року у Колумбії Надія
           Волинська.
         </div>
         <div>
